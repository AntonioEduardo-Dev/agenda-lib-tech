		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="container-login100-form-btn m-t-20">
						<button class="login100-form-btn" name="bt5">
							Apagar Livro
						</button>
					</div>
...
<?php 
	if (isset($_POST['bt1'])) {
		echo "<script>window.location='editartitulo.php';</script>";
	}
	if (isset($_POST['bt2'])) {
		echo "<script>window.location='editargenero.php';</script>";
	}
	if (isset($_POST['bt3'])) {
		echo "<script>window.location='editarautor.php';</script>";
	}
	if (isset($_POST['bt4'])) {
		echo "<script>window.location='editarquantidade.php';</script>";
	}
	if (isset($_POST['bt5'])) {
		echo "<script>window.location='apagarlivro.php';</script>";
	}
?>