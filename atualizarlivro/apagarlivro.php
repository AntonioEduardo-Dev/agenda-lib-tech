    ...
    <div class="container-login100">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
        <form class="login100-form validate-form" action="" method="POST">
          ...
          <div class="wrap-input100 rs1 validate-input" data-validate="Insira o Qr_Code">
          ...
          <div class="wrap-input100 rs1 validate-input" data-validate="Insira a Quantidade">
            <input class="input100" type="number" name="bt2" placeholder="Quantidade">
            <span class="focus-input100-1"></span>
            <span class="focus-input100-2"></span>
          </div>
...
<?php 
  ...
  if (isset($_POST['bt3'])) {
    ...
    $qrcode=$_POST['bt1'];
    $quantidade=$_POST['bt2'];

    $objcad=new Livros();
    $objcad->apagarlivro($qrcode,$quantidade);
  }
?>