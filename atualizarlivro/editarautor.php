    ...
    <div class="container-login100">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
        <form class="login100-form validate-form" action="" method="POST">
          ...
          <div class="wrap-input100 rs1 validate-input" data-validate="Insira o novo autor">
            <input class="input100" type="text" name="bt2" placeholder="Novo Autor">
            <span class="focus-input100-1"></span>
            <span class="focus-input100-2"></span>
          </div>
...
<?php 
  ...
  if (isset($_POST['bt3'])) {
    ...
    $objcad=new Livros();
    $objcad->editaautor($qrcode,$autor);
  }
?>