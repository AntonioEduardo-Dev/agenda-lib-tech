      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
        <form class="login100-form validate-form" action="" method="POST">
          ...
          <div class="wrap-input100 validate-input" data-validate = "Insira uma matricula válida">
            <input class="input100" type="number" name="bt1" placeholder="Sua matricula">
            <span class="focus-input100-1"></span>
            <span class="focus-input100-2"></span>
          </div>
                    
                    <div class="wrap-input100 rs1 validate-input" data-validate="Sua senha">
            <input class="input100" type="password" name="bt2" placeholder="Senha Atual">
            <span class="focus-input100-1"></span>
            <span class="focus-input100-2"></span>
          </div>
          
          <div class="wrap-input100 rs1 validate-input" data-validate="Nova senha">
            <input class="input100" type="password" name="bt3" placeholder="Nova Senha">
            <span class="focus-input100-1"></span>
            <span class="focus-input100-2"></span>
          </div>
...
<?php
    if(isset($_POST['bt4'])){
        ...
        $objatualiza->editarsenha($matricula,$senha,$senhanova);
    }
